...
import org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceConnector;
...
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.COLLECTION_INCLUDE_LIST;
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.DATABASE_INCLUDE_LIST;
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_MAX_THREADS_CONFIG;
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_PIPELINE_CONFIG;
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_QUEUE_SIZE_CONFIG;
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBConnectorSourceTask.STARTUP_MODE_TIMESTAMP_START_AT_OPERATION_TIME_CONFIG;
...
import static org.apache.flink.cdc.connectors.mongodb.internal.MongoDBEnvelope.OUTPUT_SCHEMA;
